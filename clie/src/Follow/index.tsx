...
//   useEffect(() => {
//     // Update following list from context
//     if (user?.result) {
...
//       try {
//         const res = await axios.get("http://localhost:3002/auth/all");
...
//     try {
//      const response= await axios.put(`http://localhost:3002/auth/follow/${targetUserId}/${loggedInId}`);

   
//       console.log("Followed user:", targetUserId);
//       console.log("Resposne",response.data);
//       const res = await axios.get(`http://localhost:3002/auth/following/${loggedInId}`);
//       console.log("Following list:", res.data.result);
...
//                 src={
//                   u.image
//                     ? `http://localhost:3002/uploads/${u.image}`
//                     : "/default-avatar.png"
//                 }
//                 alt={u.name}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <AnimatePresence>
            {allUsers.map((u: any) => (
              ...
              >
                <img
                  src={u.image ? `http://localhost:3002/uploads/${u.image}` : "/default-avatar.png"}
                  alt={u.name}
                  className="w-24 h-24 rounded-full object-cover mb-3"
                />
                <h3 className="text-lg font-medium">{u.name}</h3>
